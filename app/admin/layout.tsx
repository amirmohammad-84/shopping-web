...
import SidebarLayoutAdmin from "../components/admin/layouts/sidebarLayoutAdmin";
...
const AdminPanelLayout = ({ children }: Props) => {
  ...
  return (
    <div className="mt-16">
      <div>
        <SidebarLayoutAdmin open={sidebarOpen} setOpen={setSidebarOpen} />
                ...
                <Menu as="div" className="relative ml-6">
                  <div>
                    <Menu.Button className="flex max-w-xs items-center rounded-full bg-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                      <span className="sr-only">بازکردن منو کاربر</span>
                      <Image
                        width={48}
                        height={48}
