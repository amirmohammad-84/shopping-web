            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border-l-4 border-blue-500">
                        ...
                        <div className='mr-1'>
                            <p className="text-gray-500 text-sm font-medium">اشتراک ویژه</p>
                            <h3 className="text-2xl font-bold mt-1 text-gray-800">27 روز</h3>
                        </div>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border-l-4 border-green-500">
                        <div className="flex justify-between items-start">
                        <div className='mr-1'>
                            <p className="text-gray-500 text-sm font-medium">سفارشات ثبت شده</p>
                            <h3 className="text-2xl font-bold mt-1 text-gray-800">13</h3>
                        </div>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow border-l-4 border-purple-500">
                        <div className="flex justify-between items-start">
                        <div className='mr-1'>
                            <p className="text-gray-500 text-sm font-medium">میانگین نظرات</p>
                            <h3 className="text-2xl font-bold mt-1 text-gray-800">4.42</h3>
                        </div>
