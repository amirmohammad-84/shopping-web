...
export default async function Home({ searchParams }: Props) {
  ...
  return (
    <main className="flex min-h-screen bg-[#e0e5ec] text-gray-800 max-w-screen flex-col">
      <Header />
      <div>
        {/* Hero Section */}
        <section className="hero-container p-10 md:p-20">
          <div className="hero-content flex items-center justify-center h-full text-center text-white py-20 md:py-32 px-4 md:px-6">
            <div className="container mx-auto">
              <div className="inline-block bg-[rgba(120,72,38,0.08)] backdrop-blur-lg rounded-xl px-8 md:px-20 py-8 md:py-12 shadow-md transition-all duration-300 ease-in-out">
                <h1 className="text-amber-800 font-cursive text-4xl md:text-7xl mb-4">
                  چای و قهوه
                </h1>
                <p className="text-amber-500 text-lg md:text-2xl mb-6">
                  لورم ایپسوم متن ساختگی با تولید
                </p>
                <Link
                  href="/products"
                  className="bg-amber-700 hover:bg-amber-600 text-white px-6 md:px-8 py-3 rounded-lg text-base md:text-lg font-semibold"
                >
                  مشاهده محصولات
                </Link>
              </div>
        ...
        {/* Products Section */}
        <section id="menu" className="py-12 md:py-16 bg-amber-50">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="text-2xl md:text-3xl font-bold text-center text-amber-900 mb-4">
              منو
            </h2>
            <p className="text-center text-gray-600 mb-8 md:mb-12 max-w-2xl mx-auto">
              مجموعه ای از قهوه های دست ساز و چای ممتاز را از سرتاسر جهان که با دقت ساخته شده است، تست کنید.
            </p>
        ...
        >
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col lg:flex-row items-center text-center max-w-4xl mx-auto">
        ...
        <section className="py-12 md:py-16 bg-amber-900 text-white">
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-4">همیشه به روز بمانید</h2>
            ...
            <form className="max-w-md mx-auto flex flex-col sm:flex-row">
              <input
                ...
                className="w-full sm:rounded-r-lg sm:rounded-l-none px-4 py-3 bg-[#e0e5ec] text-gray-700 placeholder-gray-500 shadow-[inset_4px_4px_8px_#c5c9cc,_inset_-4px_-4px_8px_#ffffff] focus:outline-none focus:ring-2 focus:ring-blue-300 transition duration-200 ease-in-out mb-4 sm:mb-0"
              />
              <button
                type="submit"
                className="bg-amber-700 hover:bg-amber-600 px-6 py-3 sm:rounded-l-lg sm:rounded-r-none font-semibold"
              >
                ارسال
              </button>
            </form>
